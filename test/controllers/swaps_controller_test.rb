...
class SwapsControllerTest < ActionController::TestCase
  ...
  test "should create swap" do
    assert_difference('Swap.count') do
      post :create, swap: { location: @swap.location, swap_description: @swap.swap_description, when: @swap.when }
    end
  ...
  test "should update swap" do
    patch :update, id: @swap, swap: { location: @swap.location, swap_description: @swap.swap_description, when: @swap.when }
    assert_redirected_to swap_path(assigns(:swap))
  end
